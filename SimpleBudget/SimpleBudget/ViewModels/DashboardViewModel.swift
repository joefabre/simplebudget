...
class DashboardViewModel: ObservableObject {
    ...
    // Calculate income-related metrics
    private func calculateIncomeMetrics() {
        if let budget = currentBudget {
            // Get total monthly income from Budget extensions
            totalMonthlyIncome = budget.totalMonthlyIncome
            
            // Get income source count
            incomeSourceCount = budget.incomeSources.count
